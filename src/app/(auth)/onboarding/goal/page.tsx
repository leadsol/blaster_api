...
const goalOptions = [
  { id: 'mass-messages', label: 'לשלוח הודעות המוניות' },
  { id: 'automate-whatsapp', label: 'לאוטומט מענה וואטסאפ' },
  { id: 'for-client', label: 'להשתמש עבור לקוח' },
  { id: 'try-test', label: 'לנסות/רק לבדוק' },
  { id: 'increase-conversions', label: 'להגדיל המרות' },
  { id: 'other', label: 'אחר' },
]
...
export default function OnboardingGoalPage() {
  ...
  const handleNext = () => {
    if (selectedOption) {
      localStorage.setItem('onboarding_goal', selectedOption)
    ...
    <div className="min-h-screen flex bg-[#030733] relative overflow-hidden" dir="rtl">
      ...
      <div className="flex-1 lg:flex-none lg:w-[50%] flex items-center justify-center p-4 lg:p-[19px]">
        <div className="w-full max-w-[942px] h-[calc(100vh-38px)] bg-[#F2F3F8] rounded-[25px] p-6 lg:px-[45px] lg:pt-[15px] lg:pb-[25px] relative overflow-hidden">
          ...
          {/* Progress Bar - 4 segments, first three active */}
          ...
          <div className="flex flex-col items-center mt-[25px] sm:mt-[40px]">
            ...
            <h1 className="text-[#030733] text-[18px] sm:text-[24px] lg:text-[35px] font-semibold text-center mb-[20px] sm:mb-[30px] leading-[1.4] px-2">
              מה המטרה העיקרית שלך בשימוש ב-Leadsol?
            </h1>

            {/* Options Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-[12px] sm:gap-[16px] max-w-[600px] w-full mb-[20px] sm:mb-[30px] px-2">
